...
class Doc2VecC(BaseEstimator):
    ...
    def __init__(self, train_file='train_data.txt', test_file=None, word_out='wordvectors.txt', doc_out='docvectors.txt',
                 ...
                 sentence_sample=0.1, save_vocab='d2vC.data.vocab', doc2vecc_exec_file='doc2vecc.exe',
...
x=Doc2VecC(train_file="exo/exo.txt",word_out="xml1.txt",doc_out="xml.txt",dir_path="./data/")
x.get_docvecs_from_file("./data/exo/exo.txt")
