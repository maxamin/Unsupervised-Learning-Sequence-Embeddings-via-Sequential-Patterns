...
class sim_training_c:
	...
	def load_seq_items_SPs(self,file_name):
		labels, sequences = [], []
	...
	def run(self):
		...
		data_sen_X = self.assign_sequence_id(data_X)
		...
		for run in range(n_run):
			...
			d2v_dbow.train(data_sen_X, total_examples=d2v_dbow.corpus_count, epochs=50)
