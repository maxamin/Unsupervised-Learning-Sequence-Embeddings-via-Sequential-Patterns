...
def Doc2VecC_run(train_input,labels,max_samps_n):

	enwiki100_loader = Doc2vecC()

	enwiki100_loader.load_text(train_input, max_samps = max_samps_n)
	enwiki100_loader.load_label(labels, max_samps = max_samps_n)
