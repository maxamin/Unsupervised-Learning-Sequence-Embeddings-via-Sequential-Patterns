...
class sep_training_c:
	...
	def run(self):
		...
		for run in range(n_run):
			...
			d2v_i = Doc2Vec(vector_size=dim, min_count=0, workers=16, dm=0, epochs=8)
			d2v_i.build_vocab(data_seq_i)
			d2v_i.train(data_seq_i, total_examples=d2v_i.corpus_count, epochs=10)
